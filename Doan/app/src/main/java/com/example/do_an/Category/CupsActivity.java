...
public class CupsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addControls();
        // Thực hiện truy vấn SQLite để lấy các sản phẩm có category là "cups"
        loadCupsProducts();
        sessionManager = new SessionManager(this);
        addEvents();
    }
    private void loadCupsProducts() {
        // Thực hiện truy vấn SQLite để lấy dữ liệu sản phẩm từ bảng tbProducts với điều kiện là chỉ lấy các sản phẩm có category là "cups"
        try {
            cupsProducts = new ArrayList<>();
            ...
            Cursor cursor = database.rawQuery("SELECT ProductID, NamePro, Status, DecriptionPro, Image, NameCate " +
                    ...
                    "WHERE tbCategory.NameCate = 'Ly đĩa sứ'", null);
            ...
            if (cursor != null && cursor.getCount() > 0) {
                while (cursor.moveToNext()) {
                    ...
                    cupsProducts.add(new Product(productId, productName, status, imageData, categoryName, decriptionPro));
                }
                cursor.close();
            } else {
            ...
            productAdapter = new ProductAdapter(this, cupsProducts, new ProductAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(int position) {
                    // Xử lý khi một item được nhấn
                    Product product = cupsProducts.get(position);
                    ...
                    Intent intent = new Intent(CupsActivity.this, ChitietspActivity.class);
    ...
    private void addControls() {
        recyclerView = findViewById(R.id.recycler_view_cups);
    ...
    private void addEvents() {
        ivback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*
                Intent intent = new Intent(CupsActivity.this, MainActivity.class);
                startActivity(intent);*/
                finish();;
            }
        });
