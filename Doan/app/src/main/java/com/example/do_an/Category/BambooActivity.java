...
public class BambooActivity extends AppCompatActivity {
    ...
    private void loadBambooProducts() {
        try {
            bambooProducts = new ArrayList<>();
            ...
            Cursor cursor = database.rawQuery("SELECT ProductID, NamePro, Status, DecriptionPro, Image, NameCate " +
                    ...
                    "WHERE tbCategory.NameCate = 'Mỹ nghệ tre'", null);
            ...
            if (cursor != null && cursor.getCount() > 0) {
                while (cursor.moveToNext()) {
                    ...
                    bambooProducts.add(new Product(productId, productName, status, imageData, categoryName, decriptionPro));
                }
                cursor.close();
            } else {
            ...
            productAdapter = new ProductAdapter(this, bambooProducts, new ProductAdapter.OnItemClickListener() {
                @Override
                public void onItemClick(int position) {
                    // Xử lý khi một item được nhấn
                    Product product = bambooProducts.get(position);
                    ...
                    Intent intent = new Intent(BambooActivity.this, ChitietspActivity.class);
    ...
    private void addControls() {
        recyclerView = findViewById(R.id.recycler_view_bamboo);
    ...
    private void addEvents() {
        ivback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*
                Intent intent = new Intent(BambooActivity.this, MainActivity.class);
                startActivity(intent);*/
                finish();;
            }
        });
